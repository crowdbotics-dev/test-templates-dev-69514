"""
Django settings for test_templates_dev_69514 project.
...
ROOT_URLCONF = 'test_templates_dev_69514.urls'
...
WSGI_APPLICATION = 'test_templates_dev_69514.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_templates_dev_69514 API",
    "DESCRIPTION": "API documentation for test_templates_dev_69514 App",
    "VERSION": "v1",
}
